...
2.1 Copy path to your .exe file: project_folder/bin/x64/Release/ 
2.2 Open powershell(!!!as an administrator)
2.3 Go to the directory of .exe file;
2.4 To install the service, use command: 	./<path to your .exe file> /install
2.5 To uninstall the service, use command:	./<path to your .exe file> /uninstall
2.6 Find SystemAnalyzer in windows services.
2.7 Enjoy!
...
6.2 Internet connection status
